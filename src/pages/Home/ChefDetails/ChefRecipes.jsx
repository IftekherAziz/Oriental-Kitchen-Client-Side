    ...
    <div className='my-16 md:my-20'>
      <div className='text-center mb-10'>
        <h2 className='text-1xl md:text-3xl'>
          <span className='underline decoration-base-200 text-4xl md:text-5xl pl-1 md:pl-2 font-bold'>Recipes from this</span>
          <span className='text-4xl md:text-5xl text-red-800'> Chef</span>
        </h2>
      </div>
